...
/***/ "./src/components/render-results-meta.js":
/*!***********************************************!*\
  !*** ./src/components/render-results-meta.js ***!
  \***********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"renderResultMeta\": () => (/* binding */ renderResultMeta)\n/* harmony export */ });\n/* harmony import */ var _templates__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./templates */ \"./src/components/templates.js\");\n\nvar renderResultMeta = function renderResultMeta(content) {\n  var resultMetaSection = document.querySelector('#result-meta');\n\n  var allElements = function allElements(results) {\n    console.log(results);\n    var resultMeta = _templates__WEBPACK_IMPORTED_MODULE_0__.resultMetaTemplate.content.cloneNode(true);\n    var time = resultMeta.querySelector('.result-time');\n    var count = resultMeta.querySelector('.result-count');\n    time.textContent = \"in \".concat((results.processingTimeMS / 1000).toString(), \" seconds\");\n    count.textContent = \"\".concat(results.nbHits, \" results found\");\n    resultMetaSection.innerHTML = '';\n    resultMetaSection.appendChild(resultMeta);\n  };\n\n  allElements(content.results);\n};\n\n//# sourceURL=webpack://algolia-fe-hangry/./src/components/render-results-meta.js?");
